                                        ...
                                        <table class="TableContent" width="100%" style="border:1px solid #faf0d7;">
                                            ...
                                            <tr>
                                                <td style="text-align: center;">
                                                    ...
                                                    <a href="<?php if ($config['client_link']) echo $config['client_link']; ?>"
                                                       target="_new"><img style="width: 90; height: 90px; border: 0px;"
                                                                          src="<?php echo $template_path; ?>/images/download_windows.gif"></a>
                                                    <br>
                                                    <a href="<?php if ($config['client_link']) echo $config['client_link']; ?>"
                                                       target="_new" style="font-size: 12pt;">Download Client</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
...
if ($_GET['subtopic'] == 'downloadclient' and $getpage_download == 'downloadagreement') {
    ...
    <center>
        <form action="?subtopic=downloadclient" method="post" style="padding:0px;margin:0px;">
            <div class="BigButton"
                 style="background-image:url(<?php echo $template_path; ?>/images/global/buttons/sbutton.gif)">
                <div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);">
                    <div class="BigButtonOver"
                         style="background-image:url(<?php echo $template_path; ?>/images/global/buttons/sbutton_over.gif);"></div>
