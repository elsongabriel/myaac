				...
				<div style="text-align:right;">' . $player['value'] . '</div>
                                        ...
                                        if (!$i) {
                                            ...
                                            <tr bgcolor="<?php echo $config['darkborder'] ?>">
                                                <td colspan="<?php echo $skill == POT::SKILL__LEVEL ? 5 + $extra : 4 + $extra ?>">
                                                    No records yet.
                                                </td>
                                            </tr>
                                        <?php }
                                        ...
                                        if ($_page > 0) {
                                            ?>
                                            <TR>
                                                <TD WIDTH="100%" ALIGN="right" VALIGN="bottom"><A
                                                        HREF="<?php echo getLink('highscores') . '/' . $list . (isset($vocation) ? '/' . $vocation : '') . '/' . ($_page - 1) ?>"
                                                        CLASS="size_xxs">Previous Page</A></TD>
                                            </TR>
                                            <?php
                                        }
