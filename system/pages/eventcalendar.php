                        ...
                        <div class="eventscheduleheadertop">
                            <div class="eventscheduleheaderblockleft">
                                <div class="eventscheduleheaderdateblock"><span
                                        class="eventscheduleheaderleft"></span><?= date('M Y') ?>
                                    <span class="eventscheduleheaderright">
                                        <!--<a href="<?= '?eventcalendar&mes=' . $mes . '&dia=' . ($diacorrente + 1) ?>" style="color:white;">»</a>-->
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="InnerTableContainer" style="padding: 10px;">
                            <table style="width:100%;" id="eventscheduletable">
                                ...
                                function getDaysOfWeek()
                                {
                                    ...
                                    for ($i = 0; $i < 7; $i++) echo "<td>{$days[$i]}</td>";
                                }

                                function getDaysOfMonth($mes)
                                {
                                    $numero_dias = [
                                ...
                                {
                                    $meses = ['01' => "January", '02' => "February", '03' => "March",
                                ...
                                function MostreCalendario($mes)
                                {
                                    ...
                                    $numero_dias = getDaysOfMonth($mes);
