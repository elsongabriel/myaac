            ...
            <div class="box box-primary">
                <div class="box-body">
                            ...
                            <div class="col-6">
                                ...
                                <select name="group" id="group" class="form-control">
                                    <?php foreach ($acc_type as $id => $a_type): ?>
                                        <option
                                            value="<?php echo($id + 1); ?>" <?php echo($acc_group == ($id + 1) ? 'selected' : ''); ?>><?php echo $a_type; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <?php
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select name="group" id="group" class="form-control">
                                    ...
                                    foreach ($groups->getGroups() as $id => $group): ?>
                                        <option
                                            value="<?php echo $id; ?>" <?php echo($acc_group == $id ? 'selected' : ''); ?>><?php echo $group->getName(); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        <?php } ?>
                        <div class="col-6 mb-3">
                            ...
                            <select name="web_flags" id="web_flags" class="form-control">
                                ...
                                foreach ($web_acc as $id => $a_type): ?>
                                    <option
                                        value="<?php echo($id); ?>" <?php echo($account->getWebFlags() == ($id) ? 'selected' : ''); ?>><?php echo $a_type; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <select name="rl_country" id="rl_country" class="form-control">
                                <?php foreach ($countries as $id => $a_type): ?>
                                    <option
                                        value="<?php echo($id); ?>" <?php echo($account->getCountry() == ($id) ? 'selected' : ''); ?>><?php echo $a_type; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="box-footer">
                        <a href="<?php echo ADMIN_URL; ?>?p=accounts"><span class="btn btn-danger"><i
