...
<div class="row">
            ...
            <div class="">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link active" id="nav-player-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-player" type="button" role="tab" aria-controls="nav-player"
                                        aria-selected="true">Player
                                </button>
                                <button class="nav-link" id="nav-stats-tab" data-bs-toggle="tab"
                                ...
                                <button class="nav-link" id="nav-poslook-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-poslook" type="button" role="tab"
                                        aria-controls="nav-poslook" aria-selected="false">Pos/Look
                                </button>
                                <button class="nav-link" id="nav-misc-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-misc" type="button" role="tab" aria-controls="nav-misc"
                                        aria-selected="false">Misc
                                </button>

                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-player" role="tabpanel"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="group" id="group" class="form-control">
                                            <?php foreach ($groups->getGroups() as $id => $group): ?>
                                                <option
                                                    value="<?php echo $id; ?>" <?php echo($player->getGroup()->getId() == $id ? 'selected' : ''); ?>><?php echo $group->getName(); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="sex" id="sex" class="form-control">>
                                            <?php foreach ($config['genders'] as $id => $sex): ?>
                                                <option
                                                    value="<?php echo $id; ?>" <?php echo($player->getSex() == $id ? 'selected' : ''); ?>><?php echo strtolower($sex); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <select name="town" id="town" class="form-control">
                                            <?php foreach ($config['towns'] as $id => $town): ?>
                                                <option
                                                    value="<?php echo $id; ?>" <?php echo($player->getTownId() == $id ? 'selected' : ''); ?>><?php echo $town; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="col-3">
                      <label for="skills_tries[' . $id . ']" class="control-label">' . $info[0] . ' tries</label>
                        <input type="text" class="form-control" id="skills_tries[' . $id . ']" name="skills_tries[' . $id . ']" maxlength="10" autocomplete="off" style="cursor: auto;" value="' . $player->getSkillTries($id) . '"/>
                            ...
                            <div class="tab-pane fade" id="nav-poslook" role="tabpanel"
                                 aria-labelledby="nav-poslook-tab">
                    ...
                    <div class="box-footer">
                        <a href="<?php echo ADMIN_URL; ?>?p=players"><span class="btn btn-danger"><i
    ...
    <script type="text/javascript">
        ...
        $('#look_head').change(function () {
            updateOutfit()
        });
        $('#look_body').change(function () {
            updateOutfit()
        });
        $('#look_legs').change(function () {
            updateOutfit()
        });
        $('#look_feet').change(function () {
            updateOutfit()
        });
