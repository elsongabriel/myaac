                ...
                <div class="box-body">
                    <div class="box-body">
                        <button type="button" class="btn btn-myaac" data-bs-toggle="modal"
                                data-bs-target="#resetposModal"><i class="fa-solid fa-map-location-dot"></i> Reset
                            Position
                        </button>
                        <button type="button" class="btn btn-myaac" data-bs-toggle="modal"
                                data-bs-target="#resettownModal"><i class="fa-solid fa-earth-americas"></i> Reset Town
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="col-3">
            <div class="box">
                ...
                <div class="box-body">
                    <div class="box-body">
                        <button type="button" class="btn btn-myaac" data-bs-toggle="modal"
                                data-bs-target="#resetpremModal"><i class="fa-solid fa-star"></i> Reset Premium
                        </button>
                        <button type="button" class="btn btn-myaac" data-bs-toggle="modal"
